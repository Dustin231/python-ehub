...
class InputData:
    ...
    def __init__(self, ExcelPath, demands='Demand',solar='Solar Profile', tech='Energy Converters', stg='Storage', gen='General', ec='Energy Carriers', net = 'Network', imp = 'Imports', exp = 'Exports'): # if no values are passed, use defaults
        self.path = ExcelPath
...
# =============================================================================
    ...
    def Rd_Imports(self):
        ...
        self.impEC = ecID
        self.impCost = Imp["Price (CHF/kWh)"]
    ...
    def Rd_Exports(self):
        ...
        # store other parameters
        self.expEC = ecID
        self.expPrice = Exp["Export Price (CHF/kWh)"]
